...
typedef struct {
  ...
  */
  ...
  int (*simulation_device_global_interface_read)(unsigned int physical_device_id, const char* interface_name, void* host_addr, size_t dev_addr, size_t size);
  int (*simulation_device_global_interface_write)(unsigned int physical_device_id, const char* interface_name, const void* host_addr, size_t dev_addr, size_t size);
